(()=>{
                ...
                onUpdate: t=>{
                    if ("processDone" === t.type)
                        ...
                        for (let t = 0; t < this.anchorEntities.length; t++)
                            this.anchorEntities[t].targetIndex === e && (this.anchorEntities[t].el.updateWorldMatrix(i),
    ...
    AFRAME.registerComponent("mindar-image-target", {
        ...
        updateWorldMatrix(t) {
            if (this.el.object3D.visible || null === t ? this.el.object3D.visible && null === t && this.el.emit("targetLost") : this.el.emit("targetFound"),
